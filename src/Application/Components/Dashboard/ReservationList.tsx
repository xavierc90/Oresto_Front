            ...
            {sortedReservations.map((reservation, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Cacher la colonne "Détails" sur les petits écrans */}
                  <td className="text-left hidden xl:table-cell">{reservation.details || ''}</td>
            ...
            >
              ...
              <div className="flex flex-col justify-center items-center">
                <ul className="list-none pl-5 space-y-1">
                  ...
                  <li>
                    <strong>Date :</strong>{' '}
                    {new Date(selectedReservation.date_selected).toLocaleDateString()}
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Table :</strong>{' '}
                    {(selectedReservation.table && selectedReservation.table_number) ||
                      'N/A'}
                  </li>
                  <li>
                    <strong>Détails :</strong> {selectedReservation.details || 'Aucun'}
                  </li>
                </ul>
              </div>
