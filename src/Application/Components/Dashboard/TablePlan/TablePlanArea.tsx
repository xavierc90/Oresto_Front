...
export const TablePlanArea: React.FC<TableAreaProps> = ({ restaurant, token, tables, onTablesUpdate }) => {
  ...
  return (
    <div
      className="table-plan w-100 lg:h-96 lg:h-[350px] mx-auto mt-5 border border-zinc-300 bg-zinc-50 dark:bg-dark-900 dark:border-dark-800 dark:text-black relative"
      style={{
        position: 'relative',
        overflow: 'hidden',
        background:
