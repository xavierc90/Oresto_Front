(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      fetch(`http://localhost:3001/api/get-restaurant-id?url=${encodeURIComponent(url)}`)
        ...
        .then(data => {
          ...
          button.className = 'btn-light uppercase text-sm hover:text-black cursor-pointer';
          ...
          button.addEventListener('click', function() {
            ...
            widgetModal.className = 'fixed top-0 left-0 w-full h-full flex items-center justify-center z-50';
        ...
        .catch(error => {
          console.error('Erreur lors de la récupération du restaurant_id:', error);
        });
    });
  })();